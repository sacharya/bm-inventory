...
func (m *MockISOGenerator) GenerateISO(ctx context.Context, cluster common.Cluster, jobName, imageName, ignitionConfig string) *installer.GenerateClusterISOInternalServerError {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateISO", ctx, cluster, jobName, imageName, ignitionConfig)
	ret0, _ := ret[0].(*installer.GenerateClusterISOInternalServerError)
	return ret0
}

// GenerateISO indicates an expected call of GenerateISO
func (mr *MockISOGeneratorMockRecorder) GenerateISO(ctx, cluster, jobName, imageName, ignitionConfig interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerateISO", reflect.TypeOf((*MockISOGenerator)(nil).GenerateISO), ctx, cluster, jobName, imageName, ignitionConfig)
}
...
// GenerateISO mocks base method
func (m *MockISOInstallConfigGenerator) GenerateISO(ctx context.Context, cluster common.Cluster, jobName, imageName, ignitionConfig string) *installer.GenerateClusterISOInternalServerError {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateISO", ctx, cluster, jobName, imageName, ignitionConfig)
	ret0, _ := ret[0].(*installer.GenerateClusterISOInternalServerError)
	return ret0
...
// GenerateISO indicates an expected call of GenerateISO
func (mr *MockISOInstallConfigGeneratorMockRecorder) GenerateISO(ctx, cluster, jobName, imageName, ignitionConfig interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerateISO", reflect.TypeOf((*MockISOInstallConfigGenerator)(nil).GenerateISO), ctx, cluster, jobName, imageName, ignitionConfig)
}
...
// GenerateISO mocks base method
func (m *MockAPI) GenerateISO(ctx context.Context, cluster common.Cluster, jobName, imageName, ignitionConfig string) *installer.GenerateClusterISOInternalServerError {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateISO", ctx, cluster, jobName, imageName, ignitionConfig)
	ret0, _ := ret[0].(*installer.GenerateClusterISOInternalServerError)
	return ret0
...
// GenerateISO indicates an expected call of GenerateISO
func (mr *MockAPIMockRecorder) GenerateISO(ctx, cluster, jobName, imageName, ignitionConfig interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerateISO", reflect.TypeOf((*MockAPI)(nil).GenerateISO), ctx, cluster, jobName, imageName, ignitionConfig)
}
