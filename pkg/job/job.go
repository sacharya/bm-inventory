...
//OCP 4.5.3
const OverrideImageName = "quay.io/openshift-release-dev/ocp-release@sha256:eab93b4591699a5a4ff50ad3517892653f04fb840127895bb3609b3cc68f98f3"
...
type API interface {
	...
	generator.InstallConfigGenerator
}
...
func (k *kubeJob) GenerateISO(ctx context.Context, cluster common.Cluster, jobName string, imageName string, ignitionConfig string, eventsHandler events.Handler) error {
	...
	if err := k.Create(ctx, k.createImageJob(jobName, imageName, ignitionConfig, true)); err != nil {
