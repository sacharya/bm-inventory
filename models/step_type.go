...
const (
	...
	// StepTypeReset captures enum value "reset"
	StepTypeReset StepType = "reset"
)
...
func init() {
	var res []StepType
	if err := json.Unmarshal([]byte(`["hardware-info","connectivity-check","execute","inventory","install","free-network-addresses","reset"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
